...
class Service {
    ...
    fun createCompte(solde: Double, compteType: TypeCompte): Boolean {
        ...
        // Convert Double to String for serialization (ksoap2 has issues with Double directly)
        // The server should be able to parse the string back to a number
    ...
    fun deleteCompte(id: Long): Boolean {
        ...
        // Use PropertyInfo to properly serialize Long
